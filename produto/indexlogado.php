...
<body> 
<div class="topnav">
  <a class="active" href="indexlogado.php"><i class="fa fa-fw fa-home"></i> Home</a> 
   <div class="subnav">
    <button class="subnavbtn">Categorias <i class="fa fa-caret-down"></i></button>
    <div class="subnav-content">
      <a href="doceslogado.php">Doces</a>
      <a href="salgadoslogado.php">Salgados</a>
    </div>
</div>
  ...
  <div class="login1">
  <a href="index.php"><i class="fa fa-fw fa-user"></i> Sair</a>
  <a class="btn btn-primary" href="../carrinho/carrinho.php" role="button">
...
<ul class="product-list">
    ...
    <?php
        ...
        $sql = "select * from produto order by imagem ASC limit 4;";
        $bd = new Conexao();
        $con = $bd->getConexao();
    ...
    ?>
     <li class="product-item">
            <a href="../carrinho/carrinho.php" class="product-link">
...
<?php
    ...
    $sql = "select * from produto order by imagem DESC limit 4;";
    $bd = new Conexao();
    $con = $bd->getConexao();
    $Comando = $con->prepare($sql);
...
<div class="content">
    ...
    <footer id="myFooter">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                <a href="indexlogado.php"><img class="img" id="myimage" src="../img/padaria.jpg" width="90%"height="90%"><h2 class="logo"><a href=""> </a></h2>
                </div></a>
                <div class="col-sm-2">
                    <h5>Inicio</h5>
                    <ul>
