...
<body>
<div class="topnav">
  <a class="active" href="../produto/indexlogado.php"><i class="fa fa-fw fa-home"></i> Home</a> 
   <div class="subnav">
  ...
  <div class="login1">
  <a href="../produto/index.php"><i class="fa fa-fw fa-user"></i> Sair</a>
...
<div class="content">
    ...
    <footer id="myFooter">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                <a href="../produto/indexlogado.php"><img class="img" id="myimage" src="../img/padaria.jpg" width="90%"height="0%"><h2 class="logo"><a href=""> </a></h2>
                </div></a>
                <div class="col-sm-2">
                    <h5>Inicio</h5>
                    <ul>
                        <li><a href="../produto/indexlogado.php">Home</a></li>
